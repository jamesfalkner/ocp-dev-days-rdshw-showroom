...
. **Build the feature** -- Open Dev Spaces, write code with an AI assistant, and test locally
. **Ship it** -- Push your code through the CI/CD pipeline, fix any issues, and push again
. **Go live** -- Merge your changes, watch GitOps deploy to production, and verify the result
